...
class AddRecordForm(forms.ModelForm):
	...
	email = forms.EmailField(label='', required=True, widget=forms.TextInput(attrs={'class':'form_control', 'placeholder':'Email Address'}))
	phone = forms.CharField(label='', required=True, widget=forms.TextInput(attrs={'class':'form_control', 'placeholder':'Phone Number'}))
	address = forms.CharField(label='', required=True, widget=forms.TextInput(attrs={'class':'form_control', 'placeholder':'Address'}))
	city = forms.CharField(label='', required=True, widget=forms.TextInput(attrs={'class':'form_control', 'placeholder':'City'}))
