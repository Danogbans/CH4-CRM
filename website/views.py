...
def delete_record(request, pk):
	if request.user.is_authenticated:
		...
		messages.success(request, 'You Must Be Logged In To Perfrom This Operation!')
		return redirect('home')
...
def add_record(request):
	...
	if request.user.is_authenticated:
		...
		messages.success(request, "You Must Be Logged In To Perform This Operation!")
		return redirect("home")
